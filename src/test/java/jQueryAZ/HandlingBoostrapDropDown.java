...
public class HandlingBoostrapDropDown {
	...
	public void countryDropDown() {
		...
		List<WebElement> options = driver.findElements(By.xpath("//ul[@class=\"multiselect-container dropdown-menu\"]//li//label[@class=\"checkbox\"]"));
		System.out.println("Size of the optoins in DropDown : "+options.size());
		...
		for(WebElement op : options) {
			...
			if(opt.equals("Java") || op.equals("C#") || op.equals("Python")) {
				op.click();
			}
		}
